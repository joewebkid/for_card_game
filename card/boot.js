...
var style = { font: '62px "Shark"', fill: '#FFFFFF', stroke: '#000000', strokeThickness: 3, align: 'center' };
...
var Boot = { 
    create: function () 
    { 
        // LoadingText = game.add.text(game.world.width / 2, game.world.height / 2, "Loading main files", style);
