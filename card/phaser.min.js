...
var debuger = { 
    point: function (key)
    {
    	if(debug){
	    	console.time(key)
	    	// console.info(this.point.caller)
	    }
    },    
    pointEnd: function (key)
    {
    	if(debug)
    	console.timeEnd(key)
    },
...
var MoSql = { 
    ...
    getOrSet: function (key,data)
    {
    	if(base=localStorage.getItem(key)){
    		debuger.info("get from localStorage \'"+key+"\'")
    		return base
    	}else{
			localStorage.setItem( JSON.stringify(data),key  )
    		debuger.info("set to localStorage \'"+key+"\'")
			return data
    	}
    }
};
